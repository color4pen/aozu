...
// ---------------------------------------------------------------------------
// Constants (rules values — single location for adjustment)
// ---------------------------------------------------------------------------

/**
 * Maximum hops for neighborhood computation around seed elements.
 * Rule from docs/open-questions.md §8 initial version.
 */
export const SESSION_MAX_HOPS = 2;

/**
 * Summary of the aozu format rules injected into every session.
 *
 * Covers the points an agent needs to write design elements in the session:
